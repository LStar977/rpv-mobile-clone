...
export const ORG_TIERS: Record<OrgTier, OrgTierMeta> = {
  ...
  pro: {
    ...
    features: [
      'Up to 250 members',
      'Identity verification ($199 one-time unlock)',
      'Everything in Free',
      'CSV roster import',
      'Advanced analytics',
      'API access',
  ...
  plus: {
    ...
    features: [
      'Up to 1,000 members',
      'Identity verification ($499 one-time unlock)',
      'Everything in Pro',
  ...
  business: {
    ...
    features: [
      'Up to 5,000 members',
      'Identity verification ($999 one-time unlock)',
      'Everything in Plus',
  ...
  government: {
    ...
    features: [
      'Unlimited members',
      'Identity verification (custom contract)',
